...
interface AppointmentCalendarProps {
  ...
  onNextMonth: () => void;
  onDayClick: (isoDate: string, dayAppointments: BookedAppointment[]) => void;
  /** Called when user taps an appointment in the mobile day list (sets mobile detail step) */
  onMobileAppointmentClick: (appointment: BookedAppointment) => void;
  /** Called when user clicks an appointment in the desktop calendar grid (opens drawer) */
  onDesktopAppointmentClick: (appointment: BookedAppointment) => void;
  onNewManualClick: () => void;
  onMobileDayListBack: () => void;
}
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 p-2 sm:p-3">
        ...
        {/* Desktop: day appointments list below calendar */}
