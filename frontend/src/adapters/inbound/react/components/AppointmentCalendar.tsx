...
interface AppointmentCalendarProps {
  ...
  onDayCellClick: (isoDate: string, firstAppointment: BookedAppointment | undefined) => void;
  /** Called from the mobile day list — advances to detail step, does not open the desktop drawer. */
  onMobileAppointmentClick: (appointment: BookedAppointment) => void;
  /** Called from desktop calendar chip or desktop day list — opens the desktop drawer. */
  onAppointmentClick: (appointment: BookedAppointment) => void;
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    onDayCellClick(isoDate, dayAppointments[0]);
                  }}
                  type="button"
                >
                  {dateCell.day}
                        ...
                        {dayAppointments.slice(0, 2).map((appointment) => {
                          ...
                          return (
                            <button
                              ...
                              title={`${appointment.startAt.toFormat("HH:mm")} - ${appointment.endAt.toFormat("HH:mm")} | ${appointment.patientDisplayName} | ${appointment.source === "MANUAL" ? "Manual" : "Chatbot"}`}
                              type="button"
                            >
