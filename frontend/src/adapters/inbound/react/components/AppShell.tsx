...
function RocketIcon() {
  return (
    ...
    >
      <path
        d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.631 8.41m5.96 5.96a14.93 14.93 0 0 1-5.84 2.58m0 0a6 6 0 0 1-7.38-5.84h4.8"
        strokeLinecap="round"
...
const navLinks = [
  { to: "/onboarding", label: "Onboarding", Icon: RocketIcon },
  { to: "/agenda", label: "Agenda", Icon: CalendarIcon },
  { to: "/inbox", label: "Inbox", Icon: InboxIcon },
  { to: "/clientes", label: "Clientes", Icon: UsersIcon },
  { to: "/agent/prompt", label: "Prompt", Icon: TerminalIcon }
];
