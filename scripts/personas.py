...
Capability = typing.Literal[
    ...
    "skips_redundant_motivo_question",  # bot NO pregunta motivo de consulta cuando el servicio elegido es autoexplicativo (blanqueamiento, limpieza, técnica específica); solo cuando es diagnóstico/exploratorio
]
...
PSICOLOGA_PERSONAS: list[Persona] = [
    Persona(
        ...
        capabilities=[
            ...
            "respects_service_modalities",
            "skips_redundant_motivo_question",  # transversal — assertion del bot
        ],
    ),
    Persona(
