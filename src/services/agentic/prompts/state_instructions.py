    ...
    if runtime_context.state == "NO_ACTIVE_REQUEST":
        ...
        if is_returning_patient:
            ...
            return [
                ...
                "  - SOLO ofrece servicios cuyo `<internal_filter_audience>` sea "
                "`BOTH_NEW_AND_RETURNING` o `RETURNING_ONLY`. Ignora los servicios "
                "con `NEW_ONLY`.\n"
        ...
        return [
            ...
            "  2. Presenta los servicios disponibles. SOLO ofrece servicios cuyo "
            "`<internal_filter_audience>` sea `BOTH_NEW_AND_RETURNING` o `NEW_ONLY`. "
            "Ignora los servicios con `RETURNING_ONLY`.\n"
