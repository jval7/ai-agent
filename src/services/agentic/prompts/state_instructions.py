    ...
    if runtime_context.state == "NO_ACTIVE_REQUEST":
        ...
        if is_returning_patient:
            ...
            return [
                ...
                "soporta ambas; si soporta una sola, asumela). NO inventes modalidades "
                "que el servicio no liste en `<modalities>` aunque el contexto del paciente "
                "lo sugiera.\n"
        ...
        return [
            ...
            "modalidad, asume esa automaticamente y no preguntes. NO inventes modalidades: "
            "si el servicio solo lista PRESENCIAL, NO ofrezcas atender VIRTUAL aunque el "
            "paciente este en otra ciudad o pais — el contexto del paciente NO autoriza a "
            "inventar modalidades que el AgentProfile no soporta. Si el paciente necesita "
            "una modalidad que el servicio no soporta, dile honestamente que ese servicio "
            "solo se atiende [la modalidad que si soporta] y ofrece pasar a humano para "
